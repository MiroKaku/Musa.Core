...
#ifdef ALLOC_PRAGMA
#pragma alloc_text(PAGE, MI_NAME(CloseHandle))
#pragma alloc_text(PAGE, MI_NAME(DuplicateHandle))
#pragma alloc_text(PAGE, MI_NAME(CompareObjectHandles))
#pragma alloc_text(PAGE, MI_NAME(GetHandleInformation))
#pragma alloc_text(PAGE, MI_NAME(SetHandleInformation))
#endif
