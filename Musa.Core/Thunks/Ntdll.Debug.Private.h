...
#ifdef _X86_
_VEIL_DECLARE_ALTERNATE_NAME(RtlFindAndFormatMessage@28, _Musa_RtlFindAndFormatMessage@28);
#else
_VEIL_DECLARE_ALTERNATE_NAME(RtlFindAndFormatMessage, _Musa_RtlFindAndFormatMessage);
#endif
