...
_VEIL_DECLARE_ALTERNATE_NAME(RtlConvertAuxiliaryCounterToPerformanceCounter@12, _Musa_RtlConvertAuxiliaryCounterToPerformanceCounter@12);
_VEIL_DECLARE_ALTERNATE_NAME(RtlConvertPerformanceCounterToAuxiliaryCounter@12, _Musa_RtlConvertPerformanceCounterToAuxiliaryCounter@12);
#else
