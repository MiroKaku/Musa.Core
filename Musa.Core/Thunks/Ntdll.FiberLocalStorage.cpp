...
#ifdef ALLOC_PRAGMA
#pragma alloc_text(INIT, MUSA_NAME_PRIVATE(RtlFlsCreate))
#pragma alloc_text(PAGE, MUSA_NAME_PRIVATE(RtlFlsCleanup))
#pragma alloc_text(PAGE, MUSA_NAME_PRIVATE(RtlFlsDataCleanup))
...
namespace Musa
{
    ...
    )
    {
        ...
        return MUSA_NAME_PRIVATE(RtlFlsDataCleanup)(
