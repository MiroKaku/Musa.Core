...
graph TD
    ...
    D -->|PackageReference| E[Musa.CoreLite 1.2.2]
...
```xml
<ItemGroup>
  <PackageReference Include="Musa.CoreLite" Version="1.2.2" />
</ItemGroup>
```

当前仅管理一个依赖：`Musa.CoreLite` v1.2.2。
...
<metadata>
  ...
  <dependencies>
    <dependency id="Musa.CoreLite" version="1.2.2" />
  </dependencies>
</metadata>
```
